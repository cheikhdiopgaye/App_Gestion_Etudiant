...
<title>Accueil</title>
    ...
    <center>
    	...
    	<div class="input-group">
			<input type="text" class="form-control" placeholder="Search" name="marticule" id="srch-term">
			<div class="input-group-btn">
				<button name='Valider' class="btn btn-default" type="submit"><i class="glyphicon glyphicon-search"></i></button>
			</div>
		</div>
		</form>
        ...
        <div>
          <center>
        <h2><strong>Liste des étudiants</strong></h2>
        </center>
