...
if(isset($_POST['Valider'])){
      ...
      if((!empty($_POST['adresse']) && !empty($_POST['idboursier'])) && empty($_POST['idchambre']) )
      {
        $test= new EtudiantService();
        $abdou=new Boursier($_POST['matricule'],$_POST['nom'],$_POST['prenom'],$_POST['telephone'],$_POST['email'],$_POST['typebourse']);
        $test->add($abdou);  
        header("Location: index.php");
      }
      
      elseif(!empty($_POST['typebourse']) && !empty($_POST['idchambre'] && !empty($_POST['idboursier'])))
      {
        $test= new EtudiantService();
        $abdou=new Nonboursier($_POST['matricule'],$_POST['nom'],$_POST['prenom'],$_POST['telephone'],$_POST['email'],$_POST['adresse']);
        $test->add($abdou);  
        header("Location: index.php");
      ...
      {
        $test= new EtudiantService();
        $abdou=new Boursier($_POST['matricule'],$_POST['nom'],$_POST['prenom'],$_POST['telephone'],$_POST['email'],$_POST['typebourse'],$_POST['idboursier'],$_POST['idchambre']);
        $test->add($abdou);   
        header("Location: index.php");
      }
      else
    ...
    <input type="text" class="form-control" name="nom" placeholder="Nom">
                            ...
                            <div class="form-group">
                                ...
                                <div  class="haut">
                                    ...
                                    <br> <br>
                                    <div class="form-group"  id="inputTypebourse">
                                    <label for="typebourse" class="col-md-3 control-label">Type de bourse</label>
                                    <div class="col-md-9">
                                    <input type="number" class="form-control " placeholder="Type de bourse" name="typebourse">
                                    </div>
                                </div>
                                <div class="form-group class="adresse" id="inputAdresse">
                                ...
                                <div class="form-group" id="inputIdboursier">
                                    <label for="idboursier"  class="col-md-3 control-label">ID Boursier</label>
                                    <div class="col-md-9">
                                    <input type="number" class="form-control" placeholder="ID Boursier" name="idboursier">
                                    </div>
                                </div>
                                <div class="form-group"  id="inputIdchambre">
                                    <label for="idboursier"  class="col-md-3 control-label">Numéro chambre</label>
                                    <div class="col-md-9">
                                    <input type="number" class="form-control "  placeholder="Numéro chambre" name="idchambre">
